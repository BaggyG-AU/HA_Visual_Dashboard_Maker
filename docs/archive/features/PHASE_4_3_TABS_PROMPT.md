...
5. `docs/archive/features/LAYOUT_INFRASTRUCTURE_LAYER_IMPLEMENTATION.md` - Feature 4.3 spec and checklist
6. `docs/archive/features/PHASE_4_2_ACCORDION_PROMPT.md` - reference prompt format and standards framing
...
4. **Documentation**
   - Update Feature 4.3 checklist in `docs/archive/features/LAYOUT_INFRASTRUCTURE_LAYER_IMPLEMENTATION.md`
