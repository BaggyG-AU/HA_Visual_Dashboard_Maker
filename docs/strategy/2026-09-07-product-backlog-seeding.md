...
**Status:** Draft — rev 3 (2026-09-08), three record-wording corrections on the
owner's ruling after GPT-6 Astra's second scoped follow-up (`b3541c3`,
CLEAR-WITH-FINDINGS); awaiting the same reviewer's third scoped follow-up (OA
§3.4). **Owner approval for seeding given 2026-09-08, conditional on that
follow-up returning nothing above SEV 3.**
