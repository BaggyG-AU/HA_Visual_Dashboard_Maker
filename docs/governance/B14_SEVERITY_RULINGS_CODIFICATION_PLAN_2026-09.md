...
**Status:** Draft — revision 3, 2026-09-06 · answers the STRAT-D7 scoped follow-up at `cd1d412` (P2, P3 and P6 remainders at SEV 1; P7 and P8 remainders at SEV 2; new P13 and P14 at SEV 3 — every finding owner-ruled 2026-09-06 as the author recommended, after a per-seam continue / declare-residual / park brief under the plan's own same-seam rule); awaiting the second scoped follow-up. Revision 2 (`0aecb8b`) answered the plan review at `d6190d4` (P1–P12).
...
**Parent objective:** the owner's goal, stated 2026-09-06 — "we are spending more time reviewing and fixing than creating production code"; non-blocking, low-impact defects are to be recorded and triaged for a later cleanup sweep, with nothing a reviewer may REPORT reduced and nothing a SEV 1 means weakened. · **Cheapest acceptable outcome:** rulings 1–6 landed (component-scoped blocking, reachability, the Owner Summary Table, the derived verdict, the two non-repair disposition states, owner decides per Ref); rulings 7–9 could fall to a follow-up story without losing the round-count effect. · **Cost stop-rule:** if plan review plus edits plus ratification review exceed three review rounds in total, or one working week of wall-clock, work halts and re-asks the owner (mirrors §3.3's wall-clock trigger). ⚠ **Re-authorised by the owner on 2026-09-06 after the second review round:** four rounds in total — the follow-up on this revision, then the ratification review of the edits — under a hard cap: if the follow-up on this revision returns anything other than `CLEAR` or `CLEAR-WITH-FINDINGS`, work parks and returns to the owner; if the ratification review blocks, the author returns to the owner rather than repairing.
...
| 2   | To block, a reviewer must also show the condition that reaches the defect — an input, a path through the code, a state, an output, or a property of the built artifact itself — and that it exists today or is a plausible future edit. A made-up condition alone cannot block. | Template §4; OA §4 row |
