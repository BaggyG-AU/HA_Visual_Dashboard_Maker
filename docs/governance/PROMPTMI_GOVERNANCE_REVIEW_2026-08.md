...
| Per-slice independent implementation review          | The owner reviews every PR; gates and UAT check implementation. HAVDM's documented single-author failures were all **document-class** (triage, findings, specs), which R1 covers. Periodic adversarial passes (R4) audit implementation in bulk.                                                             |
