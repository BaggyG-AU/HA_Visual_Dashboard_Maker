# UAT Test Plan — v1.0.0: First stable release

**Date:** 2026-07-27
**Round:** v1.0.0 — First stable release (round 1)
**Scope:** **Full product.** Dashboard authoring, views and sections, cards, the
YAML editor, import/export fidelity, themes and presets, version control, and
...
`docs/testing/uat/matrices/uat_matrix_v1.0.0_2026-07-27.html` is generated from
...
- [ ] `./tools/checks` green — verified 2026-07-27 on `7c49ae0`, exit 0
- [ ] Suites captured and triaged — e2e 245/7/2, integration 169/0/19
- [ ] `npm run package` succeeds — verified 2026-07-27, exit 0
