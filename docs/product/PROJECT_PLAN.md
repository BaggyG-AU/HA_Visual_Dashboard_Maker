...
This document outlines the phased development plan for the HA Visual Dashboard Maker, based on confirmed user requirements. Current app version: `0.2.0-beta.1` with Electron shell, visual editor, YAML modal, Monaco integration, and Playwright integration tests in place.
...
4. Secure credential storage via keytar (pending)
5. ✅ WebSocket connection + subscriptions
6. ✅ Entity fetching and caching
7. ✅ Entity browser/picker (initial)
