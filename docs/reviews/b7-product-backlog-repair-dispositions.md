...
| ----- | --- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1    | 3   | RESOLVED    | S-P (`:110`) lists the four `fidelity` paths and says what each is; the generator entry (`:133`) keeps its source's own Planned / Deferred split and states the present-choice exclusion; the WS1 clause (`:128`) claims only that no successor was established in the reviewed sources. Header (`:6`) records the conditional approval |
