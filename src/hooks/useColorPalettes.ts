...
const defaultPalettes: Omit<ColorPalette, 'createdAt' | 'updatedAt'>[] = [
  {
    ...
    description: 'Google Material core palette',
  ...
  },
  {
    id: 'tailwind',
    name: 'Tailwind',
    description: 'Tailwind core palette',
    colors: tailwindPalette,
    isDefault: true,
  },
  {
    id: 'ha-brand',
    name: 'Home Assistant',
    description: 'Home Assistant brand colors',
    colors: haBrandPalette,
    isDefault: true,
  },
  {
    id: 'flat-ui',
    name: 'Flat UI',
    description: 'Flat UI palette',
    colors: flatUiPalette,
    isDefault: true,
  },
];
...
export function useColorPalettes(storageKey = STORAGE_KEY): UseColorPalettesReturn {
  ...
  const importPalettes = useCallback((json: string): PaletteImportResult => {
