...
describe('cardSpacing', () => {
  it('parses and normalizes all supported formats', () => {
    ...
    expect(normalizeSpacingValue('8')).toEqual({
      top: 8,
      right: 8,
      bottom: 8,
      left: 8,
    ...
    expect(normalizeSpacingValue('8px 16px')).toEqual({
      top: 8,
      right: 16,
      bottom: 8,
      left: 16,
    ...
    expect(normalizeSpacingValue('8px 12px 16px 4px')).toEqual({
      top: 8,
      right: 12,
      bottom: 16,
      left: 4,
  ...
  it('maps presets and resolves custom values', () => {
    expect(normalizeSpacingValue('none')).toEqual({
      top: 0,
      right: 0,
      bottom: 0,
      left: 0,
    ...
    expect(normalizeSpacingValue('tight')).toEqual({
      top: 4,
      right: 4,
      bottom: 4,
      left: 4,
    ...
    expect(normalizeSpacingValue('normal')).toEqual({
      top: 8,
      right: 8,
      bottom: 8,
      left: 8,
    ...
    expect(normalizeSpacingValue('relaxed')).toEqual({
      top: 16,
      right: 16,
      bottom: 16,
      left: 16,
    ...
    expect(normalizeSpacingValue('spacious')).toEqual({
      top: 24,
      right: 24,
      bottom: 24,
      left: 24,
